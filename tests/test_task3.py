...
class TestTask3(unittest.TestCase):
    ...
    def test_quantization_with_bits(self):
        signal_in = TimeSignal.read(self.src + "Quan1_input.txt")
        quantized_signal = signal_in.quantize_w_bits(
            3, save_path=self.src + "Quan1_result.txt"
        )
    ...
    def test_quantization_with_levels(self):
        ...
        quantized_signal = signal_in.quantize_w_levels(4, save_path=self.src + "Quan2_result.txt")
